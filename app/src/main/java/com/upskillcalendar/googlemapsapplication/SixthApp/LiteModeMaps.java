package com.upskillcalendar.googlemapsapplication.SixthApp;
...
public class LiteModeMaps extends AppCompatActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_lite_mode_maps);
        Toolbar toolbar = (Toolbar) findViewById(R.id.toolbar);
        setSupportActionBar(toolbar);

        // Get the map and register for the ready callback
        SupportMapFragment mapFragment =
                (SupportMapFragment) getSupportFragmentManager().findFragmentById(R.id.map5);
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        // showAustralia(null);                // this also works if the below code is commented

        final View mapView = getSupportFragmentManager().findFragmentById(R.id.map5).getView();
